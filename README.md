...
## Seed Projects
* [flatlogic/angular-dashboard-seed](https://github.com/flatlogic/angular-dashboard-seed) - Angular dashboard sample application with nodejs REST backend integration
